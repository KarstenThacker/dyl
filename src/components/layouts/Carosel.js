...
class HowTo extends Component {
  render() {
    ...
    const paragraph1 =
      "Find hair by type, color, and style, and pay for it online.";
    //Card 2
    const image2 = "Tutorial2.png";
    const header2 = "2. Get your hair.";
    const paragraph2 =
      "Meet up with your host, who will cut and wash their hair to give you.";
    //Card 3
    const image3 = "Tutorial3.png";
    const header3 = "3. Do you.";
    const paragraph3 =
      "Wear your new hair any way you want. As extensions, as a wig, etc.";
    //Card 4
    ...
    return (
      <div className="container">
        <div id="tutorial-header">
          <h1 id="hair-tutorial-header">
            Hairbnb is revolutionizing the way you shop for hair. Here's how.{" "}
          </h1>
          <span
            id="down"
